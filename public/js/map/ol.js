...
*/
    ...
    function gh(a) {
        ...
        if (this.l === hh) {
            ...
            0 < g ? b.animate({
                ...
                anchor: this.a,
                duration: 500
            }) : 0 > g && b.animate({resolution: f, easing: od, anchor: this.a, duration: 500});
            this.g = a;
            return !1
        }
        this.j += d;
    ...
    k.Qb = function (a, b, c, d, e, f) {
        if (this.ua) {
            ...
            e = this.l;
            f = this.ua.split("\n");
            var g = nk(this, f), h, l, m = Math.round(g[0] * this.jb - this.ta),
    ...
    var is = [null, "http://www.opengis.net/wms"], as = K(is, {
        ...
        }), ps = K(is, {ContactPerson: I(Q), ContactOrganization: I(Q)}), qs = K(is, {
            AddressType: I(Q),
            Address: I(Q),
            City: I(Q),
            StateOrProvince: I(Q),
    ...
    k.Th = function (a) {
        ...
        if (!this.i || !$b(this.i, f)) {
            var g = Qb("EPSG:4326"), h = f.G(), l = f.g, m = dc(l, g, f), n = l[2], p = l[1], q = l[0], t = m[3],
                u = m[2], x = m[1];
            m = m[0];
            this.g = l[3];
            this.j = n;
    ...
    k.vg = function (a, b, c) {
        var d = this.c, e = c.b, f = a.viewState, g = f.projection, h = this.a, l = h.ia(), m = l.Ta(g),
            n = m.uc(f.resolution), p = m.Ca(n), q = l.be(n, a.pixelRatio, g), t = q[0] / Ka(m.eb(n), this.S)[0],
            u = p / t, x = l.Oc(t) * l.bg(g), B = f.center, z = a.extent, G = nc(m, z, p);
    ...
    k.Vf = function (a, b) {
        var c = a, d = this.a, e = b.pixelRatio, f = b.viewState.projection, g = d.f, h = d.get(hu) || null,
            l = yw(c, d);
    ...
    v(Uw, X);
    var Vw = new vc({html: '<a class='ol-attribution - bing - tos' href='https;
://www.microsoft.com/maps/product/terms.html'>Terms of Use</a>'});Uw.prototype.U=function(){return this.o};Uw.prototype.ga=function(){return this.B};
    ...
    v(jx, Ww);
    var kx = new vc({
        html: '&copy; <a href='https://www.openstreetmap.org/copyright'>OpenStreetMap</a> contributors.'});Ij.pf={};Ij.pf.Jf=function(){};
            (function (a) {
                function b(a, b, c) {
...
:
    ...
    function Ox(a) {
        var b = a.projection || "EPSG:3857", c = a.extent || uc(b), d = a.tileGrid || sc({
            extent: c,
