...
let ol = require('ol').default;
let ol_Map = require('ol/map').default;
let ol_layer_Tile = require('ol/layer/tile').default;
let ol_control = require('ol/control').default;
let ol_control_Fullscreen = require('ol/control/fullscreen').default;
let ol_tilegrid = require('ol/tilegrid/tilegrid').default;
let ol_source_XYZ = require('ol/source/xyz').default;
let ol_View = require('ol/view').default;
let mapTileGrid = new ol_tilegrid({
