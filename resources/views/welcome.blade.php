            ...
            <div class="row">
                ...
                <div id="prepaid" class="modal">
                    <div class="modal-content">
                        <h4>Prepaid</h4>
                        <p>If you don't want to be tied down to a monthly subscription, you can use this prepaid option
                           to buy time to use the service.</p>
                ...
                <div class="col s12 l4" style="padding: 0;">
                    <div class="card z-depth-2 hoverable hover-default" style="z-index: 100;">
                        <a href="#prepaid" class="card-content center-align modal-trigger">
                            ...
                            <p class="light">With this package you can create one campaign and you won't have any time
                                             limitations.</p>
                            <ul class="checkedList left-align">
                                <li>One campaign</li>
