...
@section('content')
    <div class="container">
        <div class="row">
            <h1>Submit a link</h1>
            <form action="/campaign/new" method="post">
                @if ($errors->any())
                ...
                <div class="input-field{{ $errors->has('url') ? ' has-error' : '' }}">
                ...
                <div class="input-field{{ $errors->has('description') ? ' has-error' : '' }}">
                    ...
                    <textarea class="form-control materialize-textarea" id="description" name="description">{{ old('description') }}</textarea>
